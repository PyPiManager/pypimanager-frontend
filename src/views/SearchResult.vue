<template>
  <el-row >
    ...
    <el-col :span="14" :push="5">
      <el-table :data="tableData" stripe style="width: 100%" @cell-click="cellClickHandle" :cell-style="packageDownload">
        <el-table-column prop="index" label="#" width="100px"> </el-table-column>
        <el-table-column prop="package_name" label="包名" width="550px"></el-table-column>
        <el-table-column prop="nickname" label="上传人" width="400px"></el-table-column>
      </el-table>
    </el-col>
  </el-row>
</template>
